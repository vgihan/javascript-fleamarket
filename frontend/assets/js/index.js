  ...
  _createClass(MainContents, [{
    ...
    value: function () {
      var _asyncUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _store$getState, locate, res, items;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _store$getState = store.getState(), locate = _store$getState.locate;
                _context.next = 3;
